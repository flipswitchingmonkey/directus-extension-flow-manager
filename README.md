...
This version removes the hook from the package since it modifies the system table and otherwise, if not configured, causes the flow runs to throw an exception.

ToDo: move run counts into separate collection
